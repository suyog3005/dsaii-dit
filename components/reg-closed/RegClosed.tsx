    ...
    >
      ...
      <Link
        ...
        style={{
          ...
          fontSize: "0.75rem",
          color: `rgba(${COLOR_A}, 0.55)`,
          letterSpacing: "0.14em",
          textTransform: "uppercase",
          textDecoration: "none",
          transition: "color 0.2s",
        }}
        onMouseEnter={e => (e.currentTarget.style.color = `rgba(${COLOR_A}, 0.9)`)}
        onMouseLeave={e => (e.currentTarget.style.color = `rgba(${COLOR_A}, 0.55)`)}
      >
        <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
          <path d="M19 12H5M5 12L12 19M5 12L12 5" stroke="currentColor" strokeWidth="1.8"
